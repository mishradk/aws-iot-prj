...
#define AWS_IOT_MQTT_MIN_RECONNECT_WAIT_INTERVAL 5000 ///< Minimum time before the First reconnect attempt is made as part of the exponential back-off algorithm
